        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <button 
                onClick={onBack}
                className="w-full py-4 border-2 border-dashed border-white/20 rounded-xl font-bold uppercase tracking-widest text-xs text-white/40 hover:bg-white/5 hover:text-white transition-all"
              >
                Back to Main
              </button>
            </div>
